...
split <- rsample::initial_split(insurance_dataChange_for_correlation, prop = .8)
...
print(mean((ins_valData$charges - linear_model_predictions  )^2))

# mse using metric library
print(mse(ins_valData$charges, linear_model_predictions))
